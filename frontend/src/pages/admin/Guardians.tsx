...
export default function GuardiansPage() {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            // Buscando usuários com role parent
            const [kinshipsRes, studentsRes, guardiansRes] = await Promise.all([
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (editingId) {
                ...
                // Register User (Role Parent) and optionally backend handles Guardian creation
